class FriendshipsController < ApplicationController
  ...
  #  2. create mirror_friendship, with status 1
  #  3. create an appropriate notification
  ...
  #  2. update mirror_friendship status to 2
  #  3. create an appropriate notification
  #  4. redirect back to referer or to requester
  def update
